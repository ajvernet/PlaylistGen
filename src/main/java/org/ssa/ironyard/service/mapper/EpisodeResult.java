...
public class EpisodeResult {
	...
	return "EpisodeResult [id=" + id + ", title=" + title + ", description=" + description + ", dateCreated="
		+ dateCreated + ", identifier=" + identifier + ", digitalLocation=" + digitalLocation
		+ ", physicalLocation=" + physicalLocation + ", duration=" + duration + ", tags=" + tags
		+ ", updatedAt=" + updatedAt + ", itunesEpisode=" + itunesEpisode + ", dateAdded=" + dateAdded
		+ ", showId=" + showId + ", showTitle=" + showTitle + ", audioFiles=" + audioFiles + ", imageFiles="
		+ imageFiles + ", entities=" + entities + ", extra=" + extra + ", urls=" + urls + ", categories="
		+ categories + ", highlights=" + highlights + ", network=" + network + ", locations=" + locations
		+ ", imageUrls=" + imageUrls + ", contributors=" + contributors + ", excerpts=" + excerpts + ", topics="
		+ topics + "]";
    }
